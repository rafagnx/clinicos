...
const SubscriptionBadge = ({ org, user }) => {
  ...
  if (org?.subscription_status === 'active' || org?.subscription_status === 'manual_override' || user?.email === 'marketingorofacial@gmail.com' || user?.email === 'kriscilainemiranda@gmail.com' || org?.name?.toLowerCase()?.includes('orofacial')) {
...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Oportunidades", href: "Retention", icon: RotateCw, gradient: "from-amber-500 to-orange-500" },
    ]
  },
  {
    group: "Comercial",
