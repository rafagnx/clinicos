  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      >
        ...
        {/* Navigation */}
        <nav className="flex-1 overflow-y-auto py-4 space-y-4 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <style>{`
            ...
            {navigation.map((group, idx) => (
              <div key={idx}>
                {!isCollapsed && group.group && (
                  <h3 className="px-6 mb-1 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
                    {group.group}
                  </h3>
                )}
          ...
          {(user?.email === "rafamarketingdb@gmail.com" || user?.role === "admin") && (
            <div className="mt-4 pt-4 border-t border-slate-800 mx-4">
