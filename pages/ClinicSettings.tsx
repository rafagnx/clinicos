...
export default function ClinicSettings() {
  ...
  const { data: organization } = useQuery({
      ...
      queryFn: async () => {
        ...
        // Fetch org details using generic endpoint or user orgs
        // Since we don't have direct GET /api/organization/:id for members easily without admin role sometimes, 
        // let's use getUserOrganizations and find it.
    ...
    const getStatusLabel = () => {
      ...
      // Special case for marketing user if logic requires
